        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultSubject = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    DefaultBodyText = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialGroup = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    Incoterms = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ContactPerson = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Telephone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    YearlyPvo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsOneTimeVendor = table.Column<bool>(type: "bit", nullable: false),
                    ProposedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PurchasingOrganization = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    MsmeCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    BankDocument1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BankDocument2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GstDocument = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    VendorCodeAssignedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    VendorCodeAssignedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeletedApprover = table.Column<bool>(type: "bit", nullable: false),
                    DeletedApproverNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
