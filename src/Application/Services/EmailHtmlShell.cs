              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f6f8;padding:32px 0;">
                <tr><td align="center">
                  <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                    <tr><td style="background-color:#ffffff;background:#ffffff;padding:28px 36px 16px 36px;">
                    ...
                    <tr><td style="padding:8px 36px 32px 36px;color:#374151;font-size:14px;line-height:1.6;">{html}{actions}</td></tr>
