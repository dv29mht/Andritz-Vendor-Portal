...
public class CreateVendorRequestCommandValidator : AbstractValidator<CreateVendorRequestCommand>
{
    public CreateVendorRequestCommandValidator()
    {
        ...
        // Email is an optional vendor contact field; validate format only when supplied.
        ...
        RuleFor(x => x.PurchasingOrganization)
            .NotEmpty()
            .Must(v => v is "900D" or "900I" or "T20I")
            .WithMessage("Purchasing Organization must be one of: 900D, 900I, T20I.");
        ...
        // Financial / Bank and document fields are optional: the buyer can toggle the
        // Financial and Taxation sections off for vendors that have none, and IFSC does
        // not exist in every country. Length caps still apply when a value is supplied.
