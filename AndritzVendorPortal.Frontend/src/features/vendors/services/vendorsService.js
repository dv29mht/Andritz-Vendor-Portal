...
function buildVendorPayload(form) {
  return {
    ...
    purchasingOrganization: form.purchasingOrganization || null,
    msmeCategory:           form.msmeCategory  || null,
    bankName:               form.bankName      || null,
    branchName:             form.branchName    || null,
    bankAccountNumber:      form.bankAccountNumber || null,
    ifscCode:               form.ifscCode      || null,
    bankDocument1:          form.bankDocument1 ?? null,
    bankDocument2:          form.bankDocument2 ?? null,
    gstDocument:            form.gstDocument   ?? null,
    panDocument:            form.panDocument   ?? null,
  }
}
