        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PanCard = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    ...
                    VendorCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    VendorCodeAssignedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    VendorCodeAssignedBy = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorRequests_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    VendorRequestId = table.Column<int>(type: "INTEGER", nullable: false),
                    ApproverUserId = table.Column<string>(type: "TEXT", nullable: false),
                    ApproverName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    StepOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    Decision = table.Column<int>(type: "INTEGER", nullable: false),
                    Comment = table.Column<string>(type: "TEXT", nullable: true),
                    DecidedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsFinalApproval = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
